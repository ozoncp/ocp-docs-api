...
// Source: github.com/ocp-docs-api/internal/flusher (interfaces: Flusher)
...
func (m *MockFlusher) Flush(arg0 context.Context, arg1 []document.Document) ([]document.Document, []uint64, error) {
	m.ctrl.T.Helper()
