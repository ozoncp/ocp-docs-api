...
COPY . /home/developer/go/src/github.com/ozoncp/ocp-docs-api
RUN echo developer | sudo -S chown -R developer /home/developer/

WORKDIR /home/developer/go/src/github.com/ozoncp/ocp-docs-api
...
WORKDIR /root/
COPY --from=builder /home/developer/go/src/github.com/ozoncp/ocp-docs-api/bin/ocp-docs-api .
RUN chown root:root ocp-docs-api
#EXPOSE 82
CMD ["./ocp-docs-api"]